...
import { Activity, Droplets, Wind, Sun, TrendingUp, AlertCircle, Server, Network, Database, Cpu, HardDrive, Wifi, Shield, Terminal } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mt-8 text-center pb-6">
          ...
          <p className="text-sm text-gray-500">
            💚 Built with passion for humanitarian impact | Computer Systems Technician @ Algonquin College
          </p>
        </div>
      </div>
    </div>
